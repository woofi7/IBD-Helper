 ...
 * {@link FragmentPainCard.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentPainCard#newInstance} factory method to
...
public class FragmentPainCard extends Fragment {
    ...
    public static FragmentPainCard newInstance(boolean paramEdit) {
        FragmentPainCard fragment = new FragmentPainCard();
        Bundle args = new Bundle();
        args.putBoolean(ARG_EDIT_MODE, paramEdit);
